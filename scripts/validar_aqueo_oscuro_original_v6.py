"""Valida la colisión del Áqueo oscuro v6 contra la cabeza renderizada."""
...
HELMET = ROOT / "public/assets/models/leonidas/qa/leonidas-aqueo-dark-original-v6.glb"
REPORT = ROOT / "storage/leonidas-helmet-designs/aqueo-dark-original-v6/leonidas-aqueo-dark-original-v6-collision-report.json"
...
def main() -> None:
    ...
    for obj in candidates:
        ...
        if overlap:
            ...
            for _, polygon_index in overlap:
                ...
                centers.append(
                    sum((vertices[index] for index in polygon), vertices[polygon[0]] * 0.0)
                    / len(polygon)
                )
    ...
    print("AQUEO_V6_COLLISION_REPORT " + json.dumps(report, ensure_ascii=False))
    if not report["valid"]:
        raise SystemExit(2)
