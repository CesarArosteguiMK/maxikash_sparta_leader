...
require_once dirname($baseDir) . DIRECTORY_SEPARATOR . 'ec-shared' . DIRECTORY_SEPARATOR . 'ec___SPARTA_SECRET_REDACTED___pipeline.php';
...
if (!is_readable($autoload)) {
    fwrite(STDERR, "No se encontró PhpSpreadsheet.\n");
    exit(1);
}
