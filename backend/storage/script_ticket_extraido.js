var esAdminTicket = false;
        ...
        $(document).ready(function() {
            configuraTabla("#tablaTickets", {
                ...
                order: [[1, 'desc']],
                columns: [{"data":null,"defaultContent":"","className":"control","orderable":false},{"data":"_fecha_creacion","title":"","visible":false,"orderable":true},{"data":"folio_tipo","title":"Folio / Tipo"},{"data":"estado","title":"Estado"},{"data":"prioridad","title":"Prioridad"},{"data":"credito","title":"Crédito"},{"data":"fechas","title":"Fechas"},{"data":"dictamen_visto","title":"","orderable":false,"className":"text-end"},{"data":"acciones","title":"Acciones","orderable":false}]
            });
            getTickets();
            setInterval(function() { if (typeof actualizarCountdownsDictamen === \'function\') actualizarCountdownsDictamen(\'#tablaTickets\'); }, 10000);
            ...
            $(document).on('click', '#btnAbrirModalLevantarTicket', function() {
                ...
                if (el) {
                    if (typeof bootstrap !== "undefined" && bootstrap.Modal) { var m = bootstrap.Modal.getOrCreateInstance(el); if (m) m.show(); }
                    else if (typeof $ !== "undefined" && $.fn.modal) { $('#modalLevantarTicket').modal('show'); }
                }
            });
        });
