...
/**
 * Tickets tipo Aplicaciones de pago.
 */
class TicketAplicacionesPago extends Model
{
    public static function guardar(array $datos, $idPersonaCreador)
    {
        ...
        try {
            $db = new Database();
            $db->CRUD(
                "INSERT INTO ticket_aplicaciones_pago (id_persona_creador, tipo_solicitud, descripcion, nombre_archivo_original, ruta_adjunto, fecha_creacion) " .
            ...
            $id = $row ? (int) $row['id'] : 0;
            return self::resultado(true, 'Solicitud de aplicaciones de pago registrada correctamente.', ['id' => $id]);
        } catch (\Exception $e) {
