	...
	protected function init($code, $type, $ean)
	{
		...
		switch (strtoupper($type)) {
			...
			case 'A':
				...
				$startid = 103;
				$keys = ' !"#$%&\'()*+,-./0__SPARTA_PASSWORD_REDACTED__:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_';
			...
			case 'B':
				...
				$keys = ' !"#$%&\'()*+,-./0__SPARTA_PASSWORD_REDACTED__:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~' . chr(127);
