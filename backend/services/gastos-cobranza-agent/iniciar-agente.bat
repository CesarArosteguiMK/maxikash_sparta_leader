...
:: Si ya hay algo escuchando en 3120, no lanzar otro Node
netstat -ano 2>nul | findstr ":3120" 2>nul | findstr "LISTENING" >nul
if %errorlevel%==0 (
    echo El agente ya esta en marcha en el puerto 3120.
    ping 127.0.0.1 -n 3 >nul
    exit /b 0
)

:: Node en proceso aparte, sin ventana (logica en iniciar-agente.ps1)
...
echo Agente Gastos cobranza iniciado en segundo plano ^(puerto 3120^).
