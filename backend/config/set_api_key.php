 ...
 *
 * Requiere: tabla config_api con columna valor. Si la tabla ya tiene valor_cifrado: ALTER TABLE config_api ADD COLUMN valor TEXT NULL;
 */
...
try {
    ...
    fwrite(STDERR, "Asegúrese de tener la tabla config_api con columna valor.\n");
