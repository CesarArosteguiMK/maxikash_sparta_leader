...
/**
 * Asignación de tickets (Validaciones): líderes por segmento Campo 1–7 / 8–30.
 *
 ...
 * de los cargos directivos de 1–7 y de 8–30.
 *
 * Si deja los arrays vacíos, solo se usarán jefes (es_jefe=1) cuyo nombre de puesto
 * contenga texto reconocible (1–7, 8–30, b) 1 a 7, etc.).
 *
 * Organigrama: si existen departamentos "Campo 1-7" y "Campo 8-30", indique sus id abajo.
