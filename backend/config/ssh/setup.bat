...
REM --- 5. QUITAR HERENCIA Y DAR SOLO LECTURA ---
echo 3/3 Aplicando seguridad estricta...
REM /inheritance:r -> Quita herencia
REM /grant:r -> Reemplaza permisos existentes con SOLO Lectura (R) para tu usuario
icacls "%NOMBRE_LLAVE%" /inheritance:r /grant:r "%USERNAME%:(R)"
