...
if (!function_exists('getRutasModulos')) {
    function getRutasModulos()
    {
        ...
        $rutas['atlas/ventas'] = [202];
        $rutas['atlas/getventas'] = [202];
        $rutas['atlas/exportarventas'] = [202];
        $rutas['atlas/expedientes'] = [203];
        $rutas['atlas/getexpedientes'] = [203];
        $rutas['atlas/getexpedientedetalle'] = [203];
        $rutas['atlas/registrarmovimientoexpediente'] = [203];
        $rutas['atlas/importarexpedientes'] = [203];
