...
if (!function_exists('getMenuItemsConfig')) {
    function getMenuItemsConfig()
    {
        return [
            ...
            ['url' => '/departamentos/consulta/', 'label' => 'Estructura', 'icon' => 'fa-solid fa-cog', 'bg' => 'bg-blue', 'modulos' => [10]],
...
if (!function_exists('getRutasModulos')) {
    function getRutasModulos()
    {
        ...
        $rutas['atlas/ventas'] = [3051];
        $rutas['atlas/getventas'] = [3051];
        $rutas['atlas/exportarventas'] = [3051];
        $rutas['atlas/expedientes'] = [3052];
        $rutas['atlas/getexpedientes'] = [3052];
        $rutas['atlas/getexpedientedetalle'] = [3052];
        $rutas['atlas/registrarmovimientoexpediente'] = [3052];
        $rutas['atlas/importarexpedientes'] = [3052];
