...
';
    ...
    public function crearTicket()
    {
        ...
        if ($resultado['success'] ?? false) {
            ...
            $personasSabueso = Notificacion::getPersonasConModulos([18, 19]);
    ...
    public function marcarDictamenVisto()
    {
        ...
        if ($resultado['success'] ?? false) {
            ...
            $ids = $personasSabueso;
            if ($autorDictamen > 0 && !in_array($autorDictamen, $ids)) {
                $ids[] = $autorDictamen;
            }
