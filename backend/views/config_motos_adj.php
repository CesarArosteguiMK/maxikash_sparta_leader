...
.cma-fad-toggle:hover { background: #f8fafc; }
...
body.dark-mode .cma-fad-toggle { background: #111827; border-color: #334155; color: #e2e8f0; }
body.dark-mode .cma-fad-inner-card { background: #111827; border-color: #334155; }
        ...
        <div class="card-body">
            <ul class="nav nav-pills mb-3 gap-2" id="cmaFadTabs" role="tablist">
                <li class="nav-item" role="presentation">
                    <button class="nav-link active" id="cma-fad-tab-operacion-btn" type="button"
                            ...
                            aria-controls="cma-fad-tab-operacion" aria-selected="true">
                ...
                <li class="nav-item" role="presentation">
                    <button class="nav-link" id="cma-fad-tab-pendientes-btn" type="button"
                            ...
                            aria-controls="cma-fad-tab-pendientes" aria-selected="false">
            ...
            <div class="tab-content p-0" id="cmaFadTabContent">
                <div class="tab-pane fade show active" id="cma-fad-tab-operacion" role="tabpanel"
                     aria-labelledby="cma-fad-tab-operacion-btn">
            <div class="row g-3 align-items-stretch mb-3">
                ...
                <div class="col-12 col-lg-4">
                    <div class="cma-fad-kpi h-100">
                        ...
                        <div class="small text-muted mt-1">Casos que tienen una indicacion diferente al encendido general.</div>
                    </div>
                </div>
                <div class="col-12 col-lg-4">
                    <div class="cma-fad-kpi h-100">
                        ...
                        <button type="button" class="cma-fad-toggle" id="cmaFadToggleGlobal" aria-pressed="false">
                            ...
                            <span class="cma-fad-toggle-track" aria-hidden="true">
                                <span class="cma-fad-toggle-dot"></span>
                            </span>
                        </button>
                    </div>
                </div>
                ...
                <div class="cma-fad-inner-card" id="cmaFadExceptionControls">
                    ...
                    <div class="row g-3 align-items-end">
                        ...
                        <div class="col-12 col-lg-2 d-grid">
                            <button type="submit" class="btn btn-primary" title="Agregar excepcion">
                                <i class="fa-solid fa-plus me-1"></i>Agregar
                            </button>
                        </div>
                        <div class="col-12">
                            <div class="small text-muted">El registro queda guardado para auditoria. Si deja de aplicar, se desactiva; no se borra.</div>
                        </div>
                    </div>
                </div>
            </form>
            ...
            <div class="row g-3">
                ...
                <div class="tab-pane fade" id="cma-fad-tab-pendientes" role="tabpanel"
                     aria-labelledby="cma-fad-tab-pendientes-btn">
                <div>
...
(function () {
    ...
    function actualizarBloqueoExcepciones(encendido, disponible) {
        ...
        if (form) {
            form.classList.toggle('d-none', bloqueado);
        }
        if (cont) {
            cont.querySelectorAll('input, select, textarea, button').forEach(function (el) {
    ...
    function renderExcepciones(excepciones) {
        ...
        $fadTbody.innerHTML = excepciones.map(function (r) {
            return `<tr>
    ...
    async function guardarReglaFad(ev) {
        ...
        if (!fadGlobalEncendido) {
            Swal.fire({
                icon: 'info',
                title: 'FAD esta apagado',
                text: 'Activa primero el interruptor general para poder agregar excepciones.',
            });
            return;
        }
    ...
    document.getElementById('cmaFadCard')?.addEventListener('click', function (ev) {
        ...
        if (btnRecordatorio) {
            enviarRecordatorioFad(btnRecordatorio.getAttribute('data-fad-recordatorio'));
        }
    });
    cargar();
    cargarFad();
