...
<style>
    ...
    /* Clic en badge = detalle fechas/horas; no debe capturar el clic de la fila (mapa) */
    ...
    /* Intensidad +12h: mismo acento que btn-outline-info del modal (Intensidad +12 h) */
...
$panel_admin_chromeless_embed = !empty($panel_admin_chromeless_embed);
