...
<div class="container-fluid py-3" id="configMotosAdjRutasApp">
    <div class="cma-hero mb-3">
        <div class="d-flex flex-wrap align-items-center justify-content-between gap-3">
            <div class="d-flex align-items-center gap-3">
                <span class="cma-icon"><i class="fa-solid fa-calendar-days"></i></span>
                <div>
                    <h5 class="mb-1">Fechas de rutas de recoleccion</h5>
                    <p class="text-muted mb-0 small">Controla la anticipacion minima para programar rutas de motos adjudicadas.</p>
                </div>
            </div>
        ...
        <div class="col-12 col-xl-5">
            <div class="card cma-rule-card h-100">
                ...
                <div class="card-body small text-muted">
                    <p class="mb-2">Esta regla alimenta la programacion de rutas de tracking/recoleccion.</p>
                    <ul class="mb-0">
                        <li>Evita programar rutas con muy poca anticipacion.</li>
                        <li>Permite ajustar el minimo sin tocar el modulo de tracking.</li>
                        <li>Queda lista para crecer con reglas por CEDIS o dias no laborales.</li>
                    </ul>
                </div>
            </div>
        </div>
