    ...
    <div class="card shadow-sm border comp-av-card overflow-hidden">
        ...
        <div class="card-body border-top py-2 py-md-3 bg-body asg-footer-actions">
            <div class="d-flex flex-column align-items-start gap-2">
                <a href="/reporteria/descargarAsignacionTableroExcel?mostrar=<?= htmlspecialchars($asgMostrarQuery, ENT_QUOTES, 'UTF-8'); ?>" class="btn btn-outline-success btn-sm" title="Descarga el tablero con colores y encabezados (respeta la opción Mostrar; «Todas» exporta todo el portafolio)">
