...
14. Si solo la solicitud interna muestra una diferencia de nombre/RFC y los
    documentos oficiales (acta, CURP, identificacion, constancia fiscal, NSS,
    estado de cuenta) sostienen la misma identidad, no rechaces automaticamente:
    marca requiere_revision y explica que se debe revisar la solicitud interna.
    Si la diferencia aparece entre documentos oficiales, si puede ser critica.
...
def quick_result_to_summary(key: str, label: str, filename: str, result: Dict[str, Any]) -> Dict[str, Any]:
    ...
    validation_payload = {
        ...
        "apellido_paterno": fields.get("apellido_paterno"),
        "apellido_materno": fields.get("apellido_materno"),
        ...
        "correo_electronico": fields.get("correo_electronico"),
        ...
        "puesto_solicitado": fields.get("puesto_solicitado"),
        "expectativa_economica": fields.get("expectativa_economica"),
        "estado_salud": fields.get("estado_salud"),
        "enfermedad_cronica": fields.get("enfermedad_cronica"),
        "medicamento_controlado": fields.get("medicamento_controlado"),
        "tipo_sangre": fields.get("tipo_sangre"),
        "contactos_emergencia": fields.get("contactos_emergencia"),
        "beneficiarios": fields.get("beneficiarios"),
        "escolaridad": fields.get("escolaridad"),
