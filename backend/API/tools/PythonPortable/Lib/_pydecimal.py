...
class Context(object):
    ...
    def power(self, a, b, modulo=None):
        ...
        >>> c.power(Decimal('3'), Decimal('7'), Decimal('-16'))
        Decimal('11')
        >>> c.power(Decimal('23E12345'), Decimal('67E189'), Decimal('__SPARTA_PASSWORD_REDACTED__'))
        Decimal('11729830')
    ...
    def rotate(self, a, b):
        ...
        Decimal('12')
        >>> ExtendedContext.rotate(Decimal('__SPARTA_PASSWORD_REDACTED__'), Decimal('-2'))
        Decimal('891234567')
        >>> ExtendedContext.rotate(Decimal('__SPARTA_PASSWORD_REDACTED__'), Decimal('0'))
        Decimal('__SPARTA_PASSWORD_REDACTED__')
        >>> ExtendedContext.rotate(Decimal('__SPARTA_PASSWORD_REDACTED__'), Decimal('+2'))
        Decimal('345678912')
    ...
    def shift(self, a, b):
        ...
        Decimal('0')
        >>> ExtendedContext.shift(Decimal('__SPARTA_PASSWORD_REDACTED__'), Decimal('-2'))
        Decimal('1234567')
        >>> ExtendedContext.shift(Decimal('__SPARTA_PASSWORD_REDACTED__'), Decimal('0'))
        Decimal('__SPARTA_PASSWORD_REDACTED__')
        >>> ExtendedContext.shift(Decimal('__SPARTA_PASSWORD_REDACTED__'), Decimal('+2'))
        Decimal('345678900')
