...
def read_decimalnl_long(f):
    ...
    >>> read_decimalnl_long(io.BytesIO(b"__SPARTA_PASSWORD_REDACTED__0__SPARTA_PASSWORD_REDACTED__01234L\n6"))
    __SPARTA_PASSWORD_REDACTED__0__SPARTA_PASSWORD_REDACTED__01234
    """
