...
Uso:
  cd backend/API
  python probar_ocr.py ruta/a/imagen.jpg [TIPO]
...
# Permitir importar app cuando se ejecuta desde cualquier directorio
...
def main():
    if len(sys.argv) < 2:
        print(__doc__)
        print("Ejemplo: python probar_ocr.py C:\\fotos\\ine.jpg INE_NUEVA")
        sys.exit(1)
