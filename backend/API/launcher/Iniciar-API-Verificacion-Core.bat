@echo off
:: Flujo Docker (compose). Uso diario sin Docker: launcher\iniciar-agente.bat o launcher\Iniciar-API-Verificacion.bat
chcp 65001 >nul
...
echo  ============================================
echo.
echo  Para detener: doble clic en "launcher\Detener-API-Verificacion.bat"
echo.
