...
Ejecutar desde backend/API:
  python scripts/dev/prueba_verificar_calidad_consola.py
  python scripts/dev/prueba_verificar_calidad_consola.py ruta/a/imagen.jpg   # opcional: imagen concreta
"""
import asyncio
import sys
import os
