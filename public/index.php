...
$rutasModulos = [
    ...
    // Atención / pipeline Motos: ids alineados con modulos_web (69–73) + legado 64/65 donde aplica.
    'atencionclientes/consulta' => [64, 65, 69],
    'atencionclientes/obtenerentrantes' => [64, 65, 69],
    'atencionclientes/obtenerdictaminados' => [64, 65, 69],
    'atencionclientes/dictaminar' => [64, 65, 69],
    'atencionclientes/obtenerdictamen' => [63],
    'atencionclientes/evidencias' => [64, 65, 70],
    'atencionclientes/obtenerrecibidos' => [64, 65, 70],
    'atencionclientes/obteneraprobadosevidencias' => [64, 65, 70],
    'atencionclientes/obtenercorreccionesevidencias' => [64, 65, 70],
    'atencionclientes/recuperacion' => [64, 65, 71],
    'atencionclientes/obtenerrecuperacionentransito' => [64, 65, 71],
    'atencionclientes/obtenerdictaminadosrecuperacion' => [64, 65, 71],
    'atencionclientes/obtenerrecuperacioncierredocumentado' => [64, 65, 72],
    'atencionclientes/cierredocumentacion' => [64, 65, 72],
    'atencionclientes/obtenerdictaminadoscierredocumentacion' => [64, 65, 72],
    'atencionclientes/obtenerrecuperacionrecepcion' => [64, 65, 73],
    'atencionclientes/recepcion' => [64, 65, 73],
    'atencionclientes/obtenerdictaminadosrecepcion' => [64, 65, 73],
    'motosadjudicadas/obtenerdetalle' => [62, 63, 64, 65, 69, 70, 71, 72, 73],
    'motosadjudicadas/subirevidencia' => [64, 65, 70, 71, 72],
    'motosadjudicadas/obtenerevidenciascredito' => [64, 65, 70],
    'motosadjudicadas/guardarveredictoevidenciaatn' => [64, 65, 70],
    'motosadjudicadas/finalizarcierrevalidacionevidenciaatn' => [64, 65, 70],
    'motosadjudicadas/enviarevidenciasvalidadasatencion' => [64, 65, 70],
    'motosadjudicadas/confirmarcierredocumentacionens2' => [64, 65, 72],
    'motosadjudicadas/enviarrecuperacionacartera' => [64, 65, 71],
];
