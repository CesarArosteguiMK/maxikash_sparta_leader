...
$rutasModulos = [
    ...
    'caphum/gestion' => [4], 'caphum/gettrayectoriapuestopersona' => [4, 88], 'caphum/analizarimportaciondocumentosrrhh' => [4, 88], 'caphum/importardocumentosrrhh' => [4, 88], 'caphum/previsualizarimportaciondocumentosrrhh' => [4, 88], 'caphum/documentoscolaborador' => [92], 'caphum/getresumendocumentoscolaborador' => [92], 'caphum/documentosrrhh' => [93], 'caphum/getresumendocumentosrrhh' => [93], 'caphum/actualizacionesinfo' => [83], 'caphum/obtenerdatosactualizacioninfopersona' => [82], 'caphum/obtenerdatosactualizacioninfopersonas' => [82], 'caphum/guardaractualizacioninfopersona' => [82], 'caphum/candidatos' => [42, 104, 105], 'caphum/getcandidatos' => [42, 104, 105], 'caphum/getcandidato' => [42, 104, 105], 'caphum/guardarcandidato' => [42], 'caphum/actualizarcandidato' => [42], 'caphum/eliminarcandidato' => [42], 'caphum/enviarpostulacioncandidato' => [42], 'caphum/gettokendocumentoscandidato' => [42], 'caphum/getdocumentoscandidatolist' => [42, 104, 105], 'caphum/verificarexpedientecandidato' => [42, 104, 105], 'caphum/verdocumentocandidato' => [42, 104, 105], 'caphum/eliminardocumentocandidato' => [42, 104, 105], 'caphum/validardocumentocandidato' => [42, 104, 105], 'caphum/cerrarprocesocandidato' => [42, 104, 105], 'caphum/continuarprocesocandidato' => [42, 104, 105], 'caphum/pasarcandidatoagestion' => [42, 104, 105],
    ...
    'caphum/vacacionesadmin' => [4], 'caphum/getvacacionesadmin' => [4], 'caphum/getvacacionessolicitud' => [4], 'caphum/resolvervacacionessolicitud' => [4],
    'reporteria/callcenter' => [6], 'reporteria/resumencallcenter' => [6], 'reporteria/comparativas' => [60, 81], 'reporteria/asignacion' => [84], 'reporteria/asignaciondirecciones' => [84], 'reporteria/getasignaciondireccionescredito' => [84], 'reporteria/postasignaciondireccion' => [84], 'reporteria/postasignaciondireccionesorden' => [84], 'reporteria/postasignaciondireccionessync' => [84], 'reporteria/asignaciontablero' => [84], 'reporteria/asignaciontablerodos' => [84], 'reporteria/getasignaciontablerojson' => [84], 'reporteria/descargarasignaciontableroexcel' => [84], 'reporteria/descargarasignaciontablerodosexcel' => [84], 'reporteria/comparativasavancesemanal' => [60], 'reporteria/getcomparativasavancesemanaljson' => [60], 'reporteria/comparativocierressemanal' => [81], 'reporteria/getcomparativocierressemanaljson' => [81], 'reporteria/avancebucket' => [77], 'reporteria/getavancebucketjson' => [77],     'reporteria/primerospagos' => [49, 65, 66, 67, 68],
    ...
    'atlas/catalogos' => [102],
    'atlas/notificacionesapp' => [102],
    'atlas/sucursales' => [102],
    'atlas/getsucursales' => [102],
    ...
    'atlas/guardardistribuidor' => [102],
    'atlas/guardardiversificacion' => [102],
    'atlas/guardarclasificacion' => [102],
    'atlas/guardarordenclasificaciones' => [102],
    'atlas/notificacionesappproxy' => [102],
    ...
    'onboarding/index' => [44],
    'onboarding/video' => [44],
    'adjudicacion/administracion' => [62, 80],
    'adjudicacion/asignacioncreditos' => [62],
    'adjudicacion/dictaminarcreditos' => [80],
    'adjudicacion/diagnosticardictamenmoto' => [80],
    'adjudicacion/simulardictamenmoto' => [80],
    'adjudicacion/usuariosactivoslegacy' => [80],
    'adjudicacion/enviarcampaniagestorlegacy' => [100],
    'adjudicacion/estadodesbloqueodictamenmoto' => [80],
    'adjudicacion/desbloqueardictamenmoto' => [80],
    'adjudicacion/subirarchivodictamenmoto' => [80],
    ...
    'motosadjudicadas/monitoreoadjudicaciones' => [76],
    'motosadjudicadas/obtenermonitoreoadjudicaciones' => [76],
    ...
    'motosadjudicadas/comentarioslegacy' => [64],
    'motosadjudicadas/enviarcomentarioslegacy' => [64],
    ...
    'motosadjudicadas/enviarrechazosevidenciasbulklegacy' => [70],
    ...
    if (!is_array($modulosUsuario) || !array_intersect($modulosRequeridos, $modulosUsuario)) {
        ...
        if (!$permitirValidacionesOperativa) {
            if (solicitudEsFrontRequest()) {
                ...
                header('Content-Type: application/json; charset=utf-8');
                echo json_encode(['success' => false, 'mensaje' => 'No tienes permiso para realizar esta accion.']);
                exit;
            }
